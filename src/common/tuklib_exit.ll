...
define dso_local void @tuklib_exit(i32 noundef %status, i32 noundef %err_status, i32 noundef %show_error) local_unnamed_addr #0 {
entry:
  tail call void @exit(i32 noundef %status) #2
  unreachable
}
