...
define dso_local noundef i64 @tuklib_physmem() local_unnamed_addr #0 !dbg !10 {
entry:
    #dbg_value(i64 0, !19, !DIExpression(), !20)
  ret i64 0, !dbg !21
}
...
!1 = !DIFile(filename: "common/tuklib_physmem.c", directory: "/home/yjs/workspace/xz-test/src", checksumkind: CSK_MD5, checksum: "131b9466a59fc3be01533842b2c59ce3")
...
!10 = distinct !DISubprogram(name: "tuklib_physmem", scope: !1, file: !1, line: 72, type: !11, scopeLine: 73, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !18)
...
!18 = !{!19}
!19 = !DILocalVariable(name: "ret", scope: !10, file: !1, line: 74, type: !13)
!20 = !DILocation(line: 0, scope: !10)
!21 = !DILocation(line: 199, column: 2, scope: !10)
