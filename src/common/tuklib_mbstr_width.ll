...
define dso_local i64 @tuklib_mbstr_width(ptr nocapture noundef readonly %str, ptr noundef writeonly %bytes) local_unnamed_addr #0 {
entry:
  %call = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %str) #2
  %cmp.not = icmp eq ptr %bytes, null
