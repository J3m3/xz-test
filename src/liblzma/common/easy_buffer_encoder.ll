...
define dso_local i32 @lzma_easy_buffer_encode(i32 noundef %preset, i32 noundef %check, ptr noundef %allocator, ptr noundef %in, i64 noundef %in_size, ptr noundef %out, ptr noundef %out_pos, i64 noundef %out_size) local_unnamed_addr #0 !dbg !49 {
entry:
  %opt_easy = alloca %struct.lzma_options_easy, align 8, !DIAssignID !141
    #dbg_assign(i1 undef, !91, !DIExpression(), !141, ptr %opt_easy, !DIExpression(), !142)
    #dbg_value(i32 %preset, !83, !DIExpression(), !142)
    #dbg_value(i32 %check, !84, !DIExpression(), !142)
    #dbg_value(ptr %allocator, !85, !DIExpression(), !142)
    #dbg_value(ptr %in, !86, !DIExpression(), !142)
    #dbg_value(i64 %in_size, !87, !DIExpression(), !142)
    #dbg_value(ptr %out, !88, !DIExpression(), !142)
    #dbg_value(ptr %out_pos, !89, !DIExpression(), !142)
    #dbg_value(i64 %out_size, !90, !DIExpression(), !142)
  call void @llvm.lifetime.start.p0(i64 192, ptr nonnull %opt_easy) #3, !dbg !143
  %call = call zeroext i1 @lzma_easy_preset(ptr noundef nonnull %opt_easy, i32 noundef %preset) #3, !dbg !144
  br i1 %call, label %cleanup, label %if.end, !dbg !146

if.end:                                           ; preds = %entry
  %call1 = call i32 @lzma_stream_buffer_encode(ptr noundef nonnull %opt_easy, i32 noundef %check, ptr noundef %allocator, ptr noundef %in, i64 noundef %in_size, ptr noundef %out, ptr noundef %out_pos, i64 noundef %out_size) #3, !dbg !147
  br label %cleanup, !dbg !148

cleanup:                                          ; preds = %entry, %if.end
  %retval.0 = phi i32 [ %call1, %if.end ], [ 8, %entry ], !dbg !142
  call void @llvm.lifetime.end.p0(i64 192, ptr nonnull %opt_easy) #3, !dbg !149
...
declare !dbg !150 zeroext i1 @lzma_easy_preset(ptr noundef, i32 noundef) local_unnamed_addr #2

declare !dbg !155 i32 @lzma_stream_buffer_encode(ptr noundef, i32 noundef, ptr noundef, ptr noundef, i64 noundef, ptr noundef, ptr noundef, i64 noundef) local_unnamed_addr #2
...
!1 = !DIFile(filename: "liblzma/common/easy_buffer_encoder.c", directory: "/home/yjs/workspace/xz-test/src", checksumkind: CSK_MD5, checksum: "762e8c7ebc1c62e1479c966319025d31")
!2 = !{!3, !19, !26, !31, !38}
...
!48 = !{!"clang version 19.0.0git (git@github.com:QuqqU/GPUISel-llvm.git ed922481952e7fbe7b5da8613bc5ccf78f796536)"}
!49 = distinct !DISubprogram(name: "lzma_easy_buffer_encode", scope: !1, file: !1, line: 17, type: !50, scopeLine: 20, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !82)
...
!68 = !DIFile(filename: "GPUISel-llvm/build/lib/clang/19/include/__stddef_size_t.h", directory: "/home/yjs/workspace", checksumkind: CSK_MD5, checksum: "2c44e821a2b1951cde2eb0fb2e656867")
...
!83 = !DILocalVariable(name: "preset", arg: 1, scope: !49, file: !1, line: 17, type: !53)
!84 = !DILocalVariable(name: "check", arg: 2, scope: !49, file: !1, line: 17, type: !57)
!85 = !DILocalVariable(name: "allocator", arg: 3, scope: !49, file: !1, line: 18, type: !58)
!86 = !DILocalVariable(name: "in", arg: 4, scope: !49, file: !1, line: 18, type: !75)
!87 = !DILocalVariable(name: "in_size", arg: 5, scope: !49, file: !1, line: 18, type: !67)
!88 = !DILocalVariable(name: "out", arg: 6, scope: !49, file: !1, line: 19, type: !80)
!89 = !DILocalVariable(name: "out_pos", arg: 7, scope: !49, file: !1, line: 19, type: !81)
!90 = !DILocalVariable(name: "out_size", arg: 8, scope: !49, file: !1, line: 19, type: !67)
!91 = !DILocalVariable(name: "opt_easy", scope: !49, file: !1, line: 21, type: !92)
!92 = !DIDerivedType(tag: DW_TAG_typedef, name: "lzma_options_easy", file: !93, line: 27, baseType: !94)
!93 = !DIFile(filename: "liblzma/common/easy_preset.h", directory: "/home/yjs/workspace/xz-test/src", checksumkind: CSK_MD5, checksum: "d577811d5aeebd46232348c9f7923e50")
...
!99 = !DIFile(filename: "liblzma/api/lzma/filter.h", directory: "/home/yjs/workspace/xz-test/src", checksumkind: CSK_MD5, checksum: "5eb86d86854a7619ed1d1ac1b57b2484")
...
!104 = !DIFile(filename: "liblzma/api/lzma/vli.h", directory: "/home/yjs/workspace/xz-test/src", checksumkind: CSK_MD5, checksum: "e1aa51527ce08aa260777d4fb351a0b7")
...
!142 = !DILocation(line: 0, scope: !49)
!143 = !DILocation(line: 21, column: 2, scope: !49)
!144 = !DILocation(line: 22, column: 6, scope: !145)
!145 = distinct !DILexicalBlock(scope: !49, file: !1, line: 22, column: 6)
!146 = !DILocation(line: 22, column: 6, scope: !49)
!147 = !DILocation(line: 25, column: 9, scope: !49)
!148 = !DILocation(line: 25, column: 2, scope: !49)
!149 = !DILocation(line: 27, column: 1, scope: !49)
!150 = !DISubprogram(name: "lzma_easy_preset", scope: !93, file: !93, line: 32, type: !151, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
...
!155 = !DISubprogram(name: "lzma_stream_buffer_encode", scope: !156, file: !156, line: 270, type: !157, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!156 = !DIFile(filename: "liblzma/api/lzma/container.h", directory: "/home/yjs/workspace/xz-test/src", checksumkind: CSK_MD5, checksum: "7f878de3abe07c50108c7f7da139bedb")
!157 = !DISubroutineType(types: !158)
!158 = !{!52, !159, !57, !58, !75, !67, !80, !81, !67}
!159 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !98, size: 64)
