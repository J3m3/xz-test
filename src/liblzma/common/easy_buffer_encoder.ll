...
define dso_local i32 @lzma_easy_buffer_encode(i32 noundef %preset, i32 noundef %check, ptr noundef %allocator, ptr noundef %in, i64 noundef %in_size, ptr noundef %out, ptr noundef %out_pos, i64 noundef %out_size) local_unnamed_addr #0 {
entry:
...
if.end:                                           ; preds = %entry
  %call1 = call i32 @lzma_stream_buffer_encode(ptr noundef nonnull %opt_easy, i32 noundef %check, ptr noundef %allocator, ptr noundef %in, i64 noundef %in_size, ptr noundef %out, ptr noundef %out_pos, i64 noundef %out_size) #3
  br label %cleanup

cleanup:                                          ; preds = %entry, %if.end
  %retval.0 = phi i32 [ %call1, %if.end ], [ 8, %entry ]
