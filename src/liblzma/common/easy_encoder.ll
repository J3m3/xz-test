...
define dso_local i32 @lzma_easy_encoder(ptr noundef %strm, i32 noundef %preset, i32 noundef %check) local_unnamed_addr #0 !dbg !154 {
entry:
  %opt_easy = alloca %struct.lzma_options_easy, align 8, !DIAssignID !227
    #dbg_assign(i1 undef, !188, !DIExpression(), !227, ptr %opt_easy, !DIExpression(), !228)
    #dbg_value(ptr %strm, !185, !DIExpression(), !228)
    #dbg_value(i32 %preset, !186, !DIExpression(), !228)
    #dbg_value(i32 %check, !187, !DIExpression(), !228)
  call void @llvm.lifetime.start.p0(i64 192, ptr nonnull %opt_easy) #3, !dbg !229
  %call = call zeroext i1 @lzma_easy_preset(ptr noundef nonnull %opt_easy, i32 noundef %preset) #3, !dbg !230
  br i1 %call, label %cleanup, label %if.end, !dbg !232

if.end:                                           ; preds = %entry
  %call1 = call i32 @lzma_stream_encoder(ptr noundef %strm, ptr noundef nonnull %opt_easy, i32 noundef %check) #3, !dbg !233
  br label %cleanup, !dbg !234

cleanup:                                          ; preds = %entry, %if.end
  %retval.0 = phi i32 [ %call1, %if.end ], [ 8, %entry ], !dbg !228
  call void @llvm.lifetime.end.p0(i64 192, ptr nonnull %opt_easy) #3, !dbg !235
...
declare !dbg !236 zeroext i1 @lzma_easy_preset(ptr noundef, i32 noundef) local_unnamed_addr #2

declare !dbg !240 i32 @lzma_stream_encoder(ptr noundef, ptr noundef, i32 noundef) local_unnamed_addr #2
...
!1 = !DIFile(filename: "liblzma/common/easy_encoder.c", directory: "/home/yjs/workspace/xz-test/src", checksumkind: CSK_MD5, checksum: "3c9a4e9015360093ef9ebba762c54985")
...
!153 = !{!"clang version 19.0.0git (git@github.com:QuqqU/GPUISel-llvm.git ed922481952e7fbe7b5da8613bc5ccf78f796536)"}
!154 = distinct !DISubprogram(name: "lzma_easy_encoder", scope: !1, file: !1, line: 18, type: !155, scopeLine: 19, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !184)
...
!184 = !{!185, !186, !187, !188}
!185 = !DILocalVariable(name: "strm", arg: 1, scope: !154, file: !1, line: 18, type: !157)
!186 = !DILocalVariable(name: "preset", arg: 2, scope: !154, file: !1, line: 18, type: !182)
!187 = !DILocalVariable(name: "check", arg: 3, scope: !154, file: !1, line: 18, type: !96)
!188 = !DILocalVariable(name: "opt_easy", scope: !154, file: !1, line: 20, type: !189)
!189 = !DIDerivedType(tag: DW_TAG_typedef, name: "lzma_options_easy", file: !190, line: 27, baseType: !191)
!190 = !DIFile(filename: "liblzma/common/easy_preset.h", directory: "/home/yjs/workspace/xz-test/src", checksumkind: CSK_MD5, checksum: "d577811d5aeebd46232348c9f7923e50")
...
!228 = !DILocation(line: 0, scope: !154)
!229 = !DILocation(line: 20, column: 2, scope: !154)
!230 = !DILocation(line: 21, column: 6, scope: !231)
!231 = distinct !DILexicalBlock(scope: !154, file: !1, line: 21, column: 6)
!232 = !DILocation(line: 21, column: 6, scope: !154)
!233 = !DILocation(line: 24, column: 9, scope: !154)
!234 = !DILocation(line: 24, column: 2, scope: !154)
!235 = !DILocation(line: 25, column: 1, scope: !154)
!236 = !DISubprogram(name: "lzma_easy_preset", scope: !190, file: !190, line: 32, type: !237, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!237 = !DISubroutineType(types: !238)
!238 = !{!120, !239, !182}
!239 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !189, size: 64)
!240 = !DISubprogram(name: "lzma_stream_encoder", scope: !241, file: !241, line: 188, type: !242, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!241 = !DIFile(filename: "liblzma/api/lzma/container.h", directory: "/home/yjs/workspace/xz-test/src", checksumkind: CSK_MD5, checksum: "7f878de3abe07c50108c7f7da139bedb")
