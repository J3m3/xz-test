...
define dso_local i32 @lzma_easy_encoder(ptr noundef %strm, i32 noundef %preset, i32 noundef %check) local_unnamed_addr #0 {
entry:
...
if.end:                                           ; preds = %entry
  %call1 = call i32 @lzma_stream_encoder(ptr noundef %strm, ptr noundef nonnull %opt_easy, i32 noundef %check) #3
  br label %cleanup
