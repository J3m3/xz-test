...
define dso_local i64 @lzma_easy_encoder_memusage(i32 noundef %preset) local_unnamed_addr #0 !dbg !28 {
entry:
...
if.end:                                           ; preds = %entry
  %call1 = call i64 @lzma_raw_encoder_memusage(ptr noundef nonnull %opt_easy) #3, !dbg !100
...
declare !dbg !108 i64 @lzma_raw_encoder_memusage(ptr noundef) local_unnamed_addr #2
...
!1 = !DIFile(filename: "liblzma/common/easy_encoder_memusage.c", directory: "/home/yjs/workspace/xz-test/src", checksumkind: CSK_MD5, checksum: "fae1b715141cb47a0d4d2ef7263869c7")
!2 = !{!3, !9, !16}
...
!28 = distinct !DISubprogram(name: "lzma_easy_encoder_memusage", scope: !1, file: !1, line: 17, type: !29, scopeLine: 18, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !38)
...
!108 = !DISubprogram(name: "lzma_raw_encoder_memusage", scope: !48, file: !48, line: 138, type: !109, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
