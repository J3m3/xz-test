...
define dso_local i64 @lzma_easy_encoder_memusage(i32 noundef %preset) local_unnamed_addr #0 {
entry:
...
if.end:                                           ; preds = %entry
  %call1 = call i64 @lzma_raw_encoder_memusage(ptr noundef nonnull %opt_easy) #3
  br label %cleanup
